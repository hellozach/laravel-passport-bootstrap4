        ...
        <div>
            <div class="card">
                <div class="card-header">
                    ...
                    <a class="btn btn-sm btn-secondary pull-xs-right" @click="showCreateTokenForm">
                        Create New Token
                    </a>
                </div>
                ...
                <div class="card-block">
                    <!-- No Tokens Notice -->
                    <p class="m-b-0" v-if="tokens.length === 0">
                        You have not created any personal access tokens.
                    </p>

                    <!-- Personal Access Tokens -->
                    <table class="table table-borderless m-b-0" v-if="tokens.length > 0">
                        <thead>
                            <tr>
                                <th>Name</th>
                                <th></th>
